...
namespace seneca {
    ...
    void Menu::displayTitle(std::ostream& os, bool showColon) const {
        if (m_title && *m_title) {
    ...
    void Menu::display(ostream& os) const {
        displayTitle(os, true); // Display title with colon
        displayMenuItems(os);
    }
    ...
    ostream& operator<<(ostream& os, const Menu& menu) {
        menu.displayTitle(os, false); // Display title without colon
        return os;
    }
}