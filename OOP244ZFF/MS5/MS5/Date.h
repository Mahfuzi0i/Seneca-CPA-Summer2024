...
2024/07/15  Added the required extern values to add global variables
...
namespace seneca {
   ...
   public:
      ...
      std::istream& read(std::istream& is = std::cin);  // the read method for me to develop
      std::ostream& write(std::ostream& os = std::cout)const; // the write method for me to develop
      ...
      // The bool type conversion operator
      operator bool() const;
