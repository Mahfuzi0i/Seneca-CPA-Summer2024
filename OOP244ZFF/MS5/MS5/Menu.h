...
Description same as ms1 but without the : after the title
Revision History
-----------------------------------------------------------
Date      Reason
2024/07/01  modified display function to remove the : from the title
...
namespace seneca {
	...
	class MenuItem {
		...
		MenuItem(const char* content); // The private constructor
		...
		operator bool() const; // Bool conversion
