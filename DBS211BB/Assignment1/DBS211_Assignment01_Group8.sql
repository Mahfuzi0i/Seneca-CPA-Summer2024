...
LEFT JOIN
    dbs211_employees m ON e.reportsto = m.employeenumber
WHERE 
    e.employeenumber = 1002 OR e.employeenumber = 1056 OR e.reportsto = 1056
ORDER BY
    e.employeenumber;
...
-- Q6 Solution --
SELECT
    --I used distiinct because there are two prices that is 95.7 but we need only one maximum value
